    ...
    <v-dialog v-model="openDialog" persistent max-width="600px">
        <v-card
            ...
            <v-toolbar dark color="teal darken-3">
                <v-toolbar-title v-if="mode=='edit'">.:: Alteração de Dragão ::.</v-toolbar-title>
                <v-toolbar-title v-else>.:: Inclusão de Dragão ::.</v-toolbar-title>
                <v-spacer></v-spacer>
            </v-toolbar>

            <v-card-text>
                <v-form v-model="formCtrl" ref="form" lazy-validation>
                    <v-text-field :value.sync="createdAtFormatted" label="Criação" required
                                  ref="createdAt"
                                  v-show="isEdit"
                                  disabled
